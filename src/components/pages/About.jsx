     ...
     return (
          <div>
               ...
               <div style={{display:'flex'}}>
                    <div>
                         <img className='devCats' alt='Thomas Cat' src='https://cdn2.thecatapi.com/images/16h.jpg'></img>
                         <br></br>
                         <h1>Thomas</h1>
                         <br></br>
                    ...
                    <div>
                         <img className='devCats' alt='Stephen Cat' src='https://i.imgur.com/m6lOLAB.jpg'></img>
                         <br></br>
                         <h1>Stephen</h1>
                         <br></br>
                    ...
                    <div>
                         <img className='devCats' alt='Matt Cat' src='https://i.imgur.com/m6lOLAB.jpg'></img>
                         <br></br>
                         <h1>Matt</h1>
                         <br></br>
                         <h4>Thomas is a grumpy old man on the outside, but a lil cutie patootie on the inside. He enjoys weird and obscure music, long bike rides through nature, deep talks about philosophy/the state of humanity, and immature humor- although he pretends to enjoy immature humor ironically. He is too hip and cool for his own damn good.</h4>
                    ...
                    <div>
                         <img className='devCats' alt='Devin Cat' src='https://i.imgur.com/KgVkwhb.jpg'></img>
                         <br></br>
                         <h1>Devin</h1>
                         <br></br>
