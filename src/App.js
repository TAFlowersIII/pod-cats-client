  ...
  return (
    <Router>
      ...
      <div className="App">
        ...
        <img className='sideCat leftCat' src= 'https://i.imgur.com/fGAzAtW.png' />
        <img className='sideCat rightCat' src= 'https://i.imgur.com/Tpl6G6b.png' />
        <img className='sideCat rightLongCat' src='https://i.imgur.com/nvUPSwj.png' />
        <img className='sideCat leftLongCat' src='https://i.imgur.com/PWQqz04.png' />
        <img className='sideCat leftTopCat' src='https://i.imgur.com/UYWkQb9.png' />
        <img className='sideCat rightTopCat' src='https://i.imgur.com/IWZXtw8.png' />        
      </div>
    </Router>
  );
}
